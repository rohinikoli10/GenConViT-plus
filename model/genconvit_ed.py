...
class GenConViTED(nn.Module):
    def __init__(self, config, cnn3d_backbone=None, pretrained=True):
        ...
        #self.cnn3d = cnn3d  # Assign cnn3d attribute
        
        self.cnn3d = cnn3d_backbone
        # Make sure config contains 'img_size' key
        assert 'img_size' in config, "Configuration dictionary must contain 'img_size' key"
        
        self.backbone.patch_embed = HybridEmbed(self.embedder, self.cnn3d, img_size=config['img_size'], embed_dim=768)
