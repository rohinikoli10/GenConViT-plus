...
def vids(
    ...
    # Instantiate the CNN3D backbone
    cnn3d_backbone = CNN3D()

    # Instantiate the GenConViTED model with the CNN3D backbone
    model = GenConViTED(config, cnn3d_backbone=cnn3d_backbone)
